...
class ListOfMoviesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "ListOfMoviesCustomTableViewCell", bundle: nil), forCellReuseIdentifier: "CustomCell")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "CustomCell", for: indexPath)  as! ListOfMoviesCustomTableViewCell
